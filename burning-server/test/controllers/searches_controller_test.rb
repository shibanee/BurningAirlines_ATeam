...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { date: @search.date, destination: @search.destination, origin: @search.origin } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { date: @search.date, destination: @search.destination, origin: @search.origin } }
